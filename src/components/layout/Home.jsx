  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="hero min-h-screen relative z-10 text-white">
        <div className="hero-content flex-col lg:flex-row-reverse md:px-12">
          <img
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="py-6 text-2xl md:w-2/3 md:text-justify text-center">
            ...
            <a href="mailto:shuvodipwork@gmail.com?subject=Hello%20Shuvodip&body=I%20want%20to%20get%20started">
              <Link
                to="/contact"
                className="btn btn-xs px-4 text-xl bg-white text-black py-6 btn-xl md:btn-md"
              >
                Get In Touch
              </Link>
